       ...
       <div class="col-12 col-md-6 col-lg-3 my-3">
          <div class="card">
            ...
            <div class="card-body d-flex flex-column">
              ...
              <a href="../product.html?id=${product.id}" class="btn btn-primary mt-auto botonGoClass">Ver Más</a>
            </div>
          </div>
        </div>
       `
...
const searchProd = (ev) => {
	...
	const res = products.filter((prod) => prod.title.toLowerCase().includes(value.toLowerCase()));
	...
	res.length > 0
       ...
       <div class="col-12 col-md-6 col-lg-3">
          ...
          <div class="card-body">
              ...
              <a href="../product.html?id=${product.id}" class="btn btn-primary botonGoClass"
              >Ver Mas</a
              >
          </div>
          </div>
       ...
       `
				...
				.join(""))
		: (divCards.innerHTML = `<h2 class="text-center py-5">No hay cursos de este tipo.</h2>`);
};
